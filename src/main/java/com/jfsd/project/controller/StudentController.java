...
private FeedbackService feedbackService;
    ...
    @GetMapping("/sprofile/{id}")
    public String showStudentProfile(@PathVariable int id, Model model) {
        ...
        if (studentOpt.isPresent()) {
            ...
            // Log and return an error page if student is not found
            System.err.println("No student found with id: " + id);
            model.addAttribute("error", "Student not found");
            return "error"; // Redirect to an error JSP page
        }
    }
}
